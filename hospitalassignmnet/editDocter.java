...
public class editDocter extends JFrame implements ActionListener 
{
...
public void Edit() {
			...
			{
				JOptionPane.showMessageDialog(null, "Please enter a valid 8 digit password", "Error", JOptionPane.ERROR_MESSAGE);
				return;
			}
			...
			try
			{
				...
				System.out.println("Please enter a valid docter Id");
...
public static void main(String args[]) 
{
    java.awt.EventQueue.invokeLater(new Runnable() 
    {
        public void run() 
        {
            new editDocter().setVisible(true);
        }
    });
}
